  ...
  return (
    <nav className="">
      <div className="flex text-white relative items-center justify-between space-x-3 w-full h-[60px]  bg-[rgb(7,47,84)]">
        <img
          className=" fill w-[167px]  absolute top-0 lg:left-[50px]  ml-2"
          src={logo}
          alt="laurabon logo"
        />
        <div className="flex absolute left-[600px] items-center">
          <ul className="flex gap-7 items-center">
            <li>
              <a href="">PRAYER</a>
            </li>
            <div className="h-4 border-white border-l-2 "></div>
            <li>
              <a href="">DONATE</a>
            </li>
            <div className="h-4 border-white border-l-2 "></div>
            ...
            <li className="flex gap-2">
              <a href="" className="items-center flex gap-2">
                <ShoppingCartIcon className="h-6" /> View Cart
              </a>
            </li>
            <div className="h-4 border-white border-l-2 "></div>
            <li>
            ...
            <li className="flex ml-2 items-center bg-gray-100 rounded-full p-2">
              ...
              <input
                type="text"
                placeholder="Search"
                className="sm:hidden md:inline-flex ml-3 flex-shrink items-center bg-transparent outline-none placeholder-gray-500"
              />
            </li>
          </ul>
        </div>
      </div>
      <div className="flex sm:hidden shadow-md lg:inline-flex bg-white h-[50px] mx-auto top-[75px] items-center">
        <div className="flex mx-auto w-screen justify-center p-[10px] space-x-4 py-5 items-center">
          <p className="text-[20px] font-medium text-[rgb(3,41,61)]">WATCH + LISTEN</p>
          <div className="h-5 border-[rgba(3,41,61,1)] border-l-2 "></div>
          <p className="text-[20px] font-medium text-[rgb(3,41,61)]">LAURABON FOUNDATION</p>
          <div className="h-5 border-[rgba(3,41,61,1)] border-l-2 "></div>
