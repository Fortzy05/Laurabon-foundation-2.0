    ...
    <div className="flex h-[50px] items-center bg-white">
      <div className="">
        ...
        <div id="menu" className="md:hidden">
          <div
            className={`{isOpen ? 'open' : ''} ref={navRef} absolute flex-col items-center self-end py-8 mt-10 space-y-6 font-bold bg-gray-900 w-auto left-6 right-6 drop-shadow-md`}
          >
            <a href="#">Prayer</a>
            <a href="#">Donate</a>
            <a href="#">Shop</a>
